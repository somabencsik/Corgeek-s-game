...
namespace Table_Layout_Panel_Trying
{
    public partial class Form1 : Form
    {
        ...
        private void Mon08_Click(object sender, EventArgs e)
        {

        }

        private void Tue08_Click(object sender, EventArgs e)
        {

        }

        private void Wed08_Click(object sender, EventArgs e)
        {

        }

        private void Thu08_Click(object sender, EventArgs e)
        {

        }

        private void Fri08_Click(object sender, EventArgs e)
        {
