...
namespace TimeTable
{
    ...
    public partial class Orarend : Form
    {
        ...
        //órarend generáló fv, a matrix egy sorat kapja meg paraméterül: Kurzus[]
        public void orarendgeneralas(Kurzus[] kurzusok)
        {
            bool voltUtkozes = false;
            ...
            if (voltUtkozes)
            {
                ...
                utkozesLabel.Text = "Ebben a verzióban van ütközés. Ütköző tárgyak:\n";
                utkozesLabel.BackColor = Color.FromArgb(255, 130, 130);
                utkozespanel.BackColor = Color.FromArgb(255, 130, 130);
                foreach (string[] par in utkozo_targyak_nevei)
                {
                    utkozesLabel.Text += par[0] + "  -><-  " + par[1] + "\n";
                }
            }
            else {
                utkozesek[hanyadik_variaciot_nezzuk_eppen] = false;
                utkozesLabel.Text = "Ebben a verzióban nincs ütközés.";
                utkozesLabel.BackColor = Color.FromArgb(158, 181, 201);
                utkozespanel.BackColor = Color.FromArgb(158, 181, 201);
            }
        }
